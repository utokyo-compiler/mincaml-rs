...
fn finish(body: &TokenStream, resource: &TokenStream) -> proc_macro::TokenStream {
    quote! {
        ...
        /// imported by `middleware` to include all crates' resources in one bundle.
        ...
        pub(crate) mod fluent_generated {
            ...
            pub mod _subdiag {
                /// Default for `#[help]`
                pub const help: errors::SubdiagMessage =
                    errors::SubdiagMessage::FluentAttr(std::borrow::Cow::Borrowed("help"));
                /// Default for `#[note]`
                pub const note: errors::SubdiagMessage =
                    errors::SubdiagMessage::FluentAttr(std::borrow::Cow::Borrowed("note"));
                /// Default for `#[warn]`
                pub const warn: errors::SubdiagMessage =
                    errors::SubdiagMessage::FluentAttr(std::borrow::Cow::Borrowed("warn"));
                /// Default for `#[label]`
                pub const label: errors::SubdiagMessage =
                    errors::SubdiagMessage::FluentAttr(std::borrow::Cow::Borrowed("label"));
                /// Default for `#[suggestion]`
                pub const suggestion: errors::SubdiagMessage =
                    errors::SubdiagMessage::FluentAttr(std::borrow::Cow::Borrowed("suggestion"));
            }
        }
    }
    .into()
    ...
    for entry in resource.entries() {
        if let Entry::Message(msg) = entry {
            ...
            } in attributes
            {
                ...
                constants.extend(quote! {
                    #[doc = #msg]
                    pub const #snake_name: errors::SubdiagMessage =
                        errors::SubdiagMessage::FluentAttr(std::borrow::Cow::Borrowed(#attr_name));
                });
            }
